...
for i=1:size(Daily_Stats,1)
    ...
    if current_country_number ~= previous_country_number && size(Training_Input,2) >= 15 && previous_country_number == 1
        ...
        net = feedforwardnet(hidden_neurons1);
        ...
        net.LW{2,1} =  rand(1, hidden_neurons1);
        net.b{2} =  rand(1, 1);
        ...
        filename = strcat('E:\AGH\SSN\Projekt\SSN_Projekt\Cases_6\',country_name,'_training.txt');
        ...
        country_name = strrep(country_name,'\',' ');
        filename = strcat('E:\AGH\SSN\Projekt\SSN_Projekt\Cases_6\',country_name,'_prediction.txt');
        % Write data to text file
...
filename = strcat('E:\AGH\SSN\Projekt\SSN_Projekt\Cases_6\Performance.txt');
% Write data to text file
