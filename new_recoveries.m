...
for i=1:size(Daily_Stats,1)
    ...
    if current_country_number ~= previous_country_number && size(Training_Input,2) > 2 
        ...
        filename = strcat('E:\AGH\SSN\Projekt\SSN_Projekt\New_recoveries\',country_name,'_training.txt');
        ...
        country_name = strrep(country_name,'\',' ');
        filename = strcat('E:\AGH\SSN\Projekt\SSN_Projekt\New_recoveries\',country_name,'_prediction.txt');
        % Write data to text file
...
filename = strcat('E:\AGH\SSN\Projekt\SSN_Projekt\New_recoveries\Performance.txt');
% Write data to text file
