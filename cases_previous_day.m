...
for i=1:size(Daily_Stats,1)
    ...
    if current_country_number ~= previous_country_number && size(Training_Input,2) >= 2 && previous_country_number ~= 163 
        ...
        Training = table(Day, Cases, Previous);
        country_name = strrep(country_name,'\',' ');
        filename = strcat('C:\Users\Pawe³\Desktop\Studia\Sieci neuronowe\projekt\SSN_Projekt\Cases_Pawel\',country_name,'_training.txt');
        ...
        country_name = strrep(country_name,'\',' ');
        filename = strcat('C:\Users\Pawe³\Desktop\Studia\Sieci neuronowe\projekt\SSN_Projekt\Cases_Pawel\',country_name,'_prediction.txt');
        % Write data to text file
...
filename = strcat('C:\Users\Pawe³\Desktop\Studia\Sieci neuronowe\projekt\SSN_Projekt\Cases_Pawel\');
% Write data to text file
